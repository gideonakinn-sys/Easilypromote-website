  ...
  return (
    <div className="flex flex-1 flex-col px-5 pb-20 pt-28 md:px-10 md:pb-28 md:pt-36">
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-8 md:flex-row md:gap-16">
        <nav className="flex w-full flex-row gap-6 border-b border-rule md:sticky md:top-28 md:h-fit md:w-60 md:shrink-0 md:flex-col md:gap-1.5 md:border-b-0">
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                `-mb-px border-b-2 pb-2.5 text-sm font-semibold transition-colors md:mb-0 md:border-b-0 md:border-l-2 md:pb-0 md:pl-4 md:py-2 ${
                  isActive
                    ? 'border-stone-900 text-stone-900 md:border-amber'
